...
images:
  - title: Illustration of secondary and object RNA structure.
    filename: 'rnasec.rep.png'
    caption:

      On the left, a folding generated by mfold shows two base pairs and a
      hairpin loop. This can be represented as a tree data structure shown on
      the right.

  - title: Screenshot of unit tests running.
    filename: 'rnasec.tests.png'
    caption:
      "Screenshot of RnaSec's unit tests running."
  - title: Screenshot of genetic algorithm running.
    caption:

      Screenshot of genetic algorithm running with 10% of the population
      available for mutation.

    filename: 'rnasec.running.png'
